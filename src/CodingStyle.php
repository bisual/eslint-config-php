...
final class CodingStyle {
    ...
    /**
     * Bisual linter php configuration.
     *
     * @param array $disabled_rules The rules to be deactivated in the configuration.
     * @param array $routes         The paths where the PHP files will be searched. By default, the app, config, database, resources, routes and tests directories are used.
     * @param array $exclude_files  The files to be excluded from the configuration. By default, blade view files are excluded.
     *
     * @return Config The generated configuration.
     */
    public static function getConfig(array $disabled_rules = [], array $routes = self::ROUTES_DEFAULT, array $exclude_files = []): Config {
        ...
        $rules = array_diff_key($default_rules, array_flip($disabled_rules));
